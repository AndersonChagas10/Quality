...
$('body').off('click', '[data-salvar]').on('click', '[data-salvar]', function (e) {
    ...
    //Verifica se existe coleta j� realizada para este cargo.
    ...
    //Se n�o existir, cria uma zerada
    ...
    //Atualiza para a proxima coleta (se precisar adicionar amostra ou avalia��o)
    coletaAgrupada = AtualizaContadorDaAvaliacaoEAmostra(coletaAgrupada);

    //Mostra mensagem de que a coleta foi realizada com sucesso e fecha ap�s 3 segundos
...
function getCollectionHeaderFields() {
    ...
    $('#headerFieldDepartment input, #headerFieldDepartment select').each(function () {
        ...
        //TODO: validar se os campos de cabe�alho obrigat�rios foram preenchidos;
        if ($self.val())
