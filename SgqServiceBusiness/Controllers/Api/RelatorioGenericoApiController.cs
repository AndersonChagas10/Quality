...
{
    public class RelatorioGenericoApiController
    {
        private string conexao;
        public RelatorioGenericoApiController(string conexao)
        {
        ...
        public dynamic GetParametrizacaoGeral(FormularioParaRelatorioViewModel form)
        {
