    ...
    public class ApiRelatoriosController : BaseApiController
    {
        ...
        public List<JObject> GetGraficoSgq(JObject filtro)
        {
           ...
           var level3 = QueryNinjaPeloDbSgq("SELECT Id, Name FROM ParLevel3 WHERE Id in("+ level3ids + ")");
            ...
            {
                i["Level1Name"] = level1.FirstOrDefault(r => i.GetValue("Level1Id").Equals(r.GetValue("Id"))).GetValue("Name");
                i["Level2Name"] = level2.FirstOrDefault(r => i.GetValue("Level2Id").Equals(r.GetValue("Id"))).GetValue("Name");
                i["Level3Name"] = level3.FirstOrDefault(r => i.GetValue("Level3Id").Equals(r.GetValue("Id"))).GetValue("Name");
            }
