    ...
    public class ParamsDomain : IParamsDomain
    {
        ...
        public ParamsDTO GetLevel2(int idParLevel2, int level3Id, int level1Id)
        {
            ...
            if (level1Id > 0)
            {
                ...
                vinculosComOLevel2 = db.ParLevel3Level2.Where(r => r.ParLevel2_Id == idParLevel2 && r.IsActive == true && r.ParLevel3Level2Level1.Any(c => c.ParLevel1_Id == level1Id && c.Active == true)).ToList();
            }
        ...
        public ParamsDTO AddUpdateLevel3(ParamsDTO paramsDto)
        {
            ...
            try
            {
                ...
                _paramsRepo.SaveParLevel3(saveParamLevel3, null, null, null, null, paramsDto.level1Selected);
        ...
        var level3Value = parlevel3.ParLevel3Value.Where(r => r.IsActive == true).OrderByDescending(r => r.IsActive);
            ...
            level3.ParLevel3Value_OuterListGrouped = level3.ParLevel3Value_OuterList
                .GroupBy(r => new { r.ParMeasurementUnit_Name, r.ParCompany_Id, r.ParMeasurementUnit_Id })
