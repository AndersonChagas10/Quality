...
namespace Dominio.AcaoRH.Email
{
    public class EmailCreateAcaoResponsavel : IEmail
    {
        ...
        public void MontarBody(Acao acao)
        {
            ...
            <br><br>
            Seguindo o parâmetro da regra de Plano de Ação cadastrada no sistema SG-SEMST, informamos que você é responsável pela Ação descrita abaixo, que deverá ser executada até { (acao.DataConclusao != null ? acao.DataConclusao?.ToString("dd/MM/yyyy") : "") }.
            <br><br>
