...
namespace Dominio.AcaoRH.Email
{
    class EmailAcaoStatusAlteradoResponsavel : IEmail
    {
        ...
        public void MontarBody(Acao acao)
        {
	        ...
	        Seguindo o parâmetro da regra de Plano de Ação cadastrada no sistema SG-SEMST, informamos que a Ação descrita a seguir, de sua responsabilidade pela execução com prazo para conclusão em {acao.DataConclusao:""dd/MM/yyyy""}, teve seu status alterado.
