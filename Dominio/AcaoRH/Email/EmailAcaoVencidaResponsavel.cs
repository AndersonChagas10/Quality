...
namespace Dominio.AcaoRH.Email
{
    public class EmailAcaoVencidaResponsavel : IEmail
    {
        ...
        public void MontarBody(Acao acao)
        {
	        ...
	        Seguindo o parâmetro da regra de Plano de Ação cadastrada no sistema SG-SEMST, informamos que a Ação descrita a seguir, de sua responsabilidade pela execução, venceu em {acao.DataConclusao:""dd/MM/yyyy""}.
