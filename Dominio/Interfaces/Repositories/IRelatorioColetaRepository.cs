...
namespace Dominio.Interfaces.Repositories
{
    public interface IRelatorioColetaRepository<T> where T : class
    {
        ...
        IEnumerable<ConsolidationLevel01> GetEntryConsildatedLevel01ByDate(DataCarrierFormulario form);
        IEnumerable<ConsolidationLevel01> GetEntryConsildatedLevel01ByDateAndUnit(DataCarrierFormulario form);

        IEnumerable<CollectionLevel02> GetLastEntryCollectionLevel02(IEnumerable<ConsolidationLevel02> cl2, DataCarrierFormulario form);
        IEnumerable<CollectionLevel03> GetLastEntryCollectionLevel03(IEnumerable<CollectionLevel02> cll2, DataCarrierFormulario form);
