        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(_userSgqRoles) && !Roles.Contains("somentemanutencao-sgq"))
                    if (_userSgqRoles.Contains("somentemanutencao-sgq") && !HttpContext.Current.Request.RawUrl.Contains("/Manutencao/Index")) //!HttpContext.Current.Request.RawUrl.Contains("/ManPainelGestao/PainelIndicadoresUniManutencao"))
