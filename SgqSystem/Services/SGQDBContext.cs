    ...
    public partial class ParLevel1Alertas
    {
        ...
        public ParLevel1Alertas getAlertas(int ParLevel1_Id, int ParCompany_Id, DateTime DateCollect)
        {
            ...
            sql = "\n SELECT " +
                    ...
                    "\n                  , (SELECT TOP 1 PercentValue FROM ParGoal (nolock)  WHERE ParLevel1_Id = " + ParLevel1_Id + " AND (ParCompany_Id = " + ParCompany_Id + " OR ParCompany_Id IS NULL) AND EffectiveDate <= CONVERT(DATE, '" + _DataCollect + "') ORDER BY ParCompany_id DESC,EffectiveDate DESC) AS _META " +
                    "\n                FROM " +
                    "\n         ( " +
                    "\n             /*****PCC1b**************************************************************************************************************************************************************************/ " +
                    "\n             SELECT * FROM " +
