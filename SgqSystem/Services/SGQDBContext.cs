...
namespace SGQDBContext
{
    ...
    public partial class ParLevelHeader
    {
        ...
        public IEnumerable<ParLevelHeader> getHeaderByLevel1(int ParLevel1_Id)
        {
            ...
            string sql = "SELECT PH.Id AS ParHeaderField_Id, PH.Name AS ParHeaderField_Name, PH.Description AS ParHeaderField_Description, PT.Id AS ParFieldType_Id, PH.LinkNumberEvaluetion AS LinkNumberEvaluetion, PH.IsRequired AS IsRequired FROM ParLevel1XHeaderField PL (nolock)   " +
                         ...
                         "GROUP BY PH.Id, PH.Name, PT.Id, PH.IsRequired, PH.Description, PH.LinkNumberEvaluetion                                                                                                                             ";
        ...
        public IEnumerable<ParLevelHeader> getHeaderByLevel1Level2(int ParLevel1_Id, int ParLevel2_Id)
        {
            ...
            string sql = "SELECT PH.Id AS ParHeaderField_Id, PH.Name AS ParHeaderField_Name, PH.Description AS ParHeaderField_Description, PT.Id AS ParFieldType_Id, PH.LinkNumberEvaluetion AS LinkNumberEvaluetion, PH.IsRequired AS IsRequired FROM ParLevel1XHeaderField PL  (nolock)  " +
                         ...
                         "PL.ParLevel1_Id = " + ParLevel1_Id + " AND                                                                                                                                                     " +
                         "PL.IsActive = 1 AND PH.IsActive = 1 AND PD.IsActive = 1                                                                                                                                        " +
                         "GROUP BY PH.Id, PH.Name, PT.Id, PH.Description, PH.IsRequired, PH.LinkNumberEvaluetion;                                                                                                                             ";
