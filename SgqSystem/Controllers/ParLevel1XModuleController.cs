...
namespace SgqSystem.Controllers
{
    public class ParLevel1XModuleController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,ParLevel1_Id,ParModule_Id,EffectiveDateStart,EffectiveDateEnd")] ParLevel1XModule parLevel1XModule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,ParLevel1_Id,ParModule_Id,EffectiveDateStart,EffectiveDateEnd")] ParLevel1XModule parLevel1XModule)
        {
            parLevel1XModule.AlterDate = DateTime.Now;
