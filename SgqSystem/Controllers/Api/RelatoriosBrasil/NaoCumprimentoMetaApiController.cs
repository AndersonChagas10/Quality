...
namespace SgqSystem.Controllers.Api.Renan
{
    [EnableCors(origins: "*", headers: "*", methods: "*")]
    [RoutePrefix("api/NaoCumprimentoMeta")]
    public class NaoCumprimentoMetaApiController : ApiController
    {
        ...
        private void CriaMockGrafico1Level1()
        {
            ...
            _mock.listResultSetLevel1 = new List<NaoCumprimentoMetaResultSet>();
            _mock.listResultSetTendencia = new List<NaoCumprimentoMetaResultSet>();
            _mock.listResultSetLevel2 = new List<NaoCumprimentoMetaResultSet>();
            _mock.listResultSetTarefaPorIndicador = new List<NaoCumprimentoMetaResultSet>();
            _mock.listResultSetLevel3 = new List<NaoCumprimentoMetaResultSet>();

            /*Query 1 para Indicador*/
            _mock.listResultSetLevel1.Add(new NaoCumprimentoMetaResultSet()
            {
                level1_Id = 1,
                Level1Name = "TINGIR",
                Unidade_Id = 1,
            ...
            foreach (var i in _mock.listResultSetLevel1)
            {
                ...
                for (int j = 0; j < 30; j++)
                {
                    if (j == 5)
                    {
                        //_mock.listResultSetTendencia.Add(new NaoCumprimentoMetaResultSet()
                        //{
                ...
                _mock.listResultSetLevel2.Add(new NaoCumprimentoMetaResultSet()
                {
                    level1_Id = i.level1_Id,
                    level2_Id = counter,
                    Level1Name = i.Level1Name,
                ...
                _mock.listResultSetTarefaPorIndicador.Add(new NaoCumprimentoMetaResultSet()
                {
                    level1_Id = i.level1_Id,
                    level2_Id = counter,
            ...
            foreach (var i in _mock.listResultSetLevel1)
            {
                ...
                foreach (var ii in _mock.listResultSetLevel2.Where(r => r.level1_Id == i.level1_Id))
                {
                    ...
                    _mock.listResultSetLevel3.Add(new NaoCumprimentoMetaResultSet()
                    {
        ...
        public NaoCumprimentoMetaApiController()
        {
        ...
        public PanelResulPanel GetGrafico1Level1([FromBody] FormularioParaRelatorioViewModel form)
        {
            ...
            CommonLog.SaveReport(form, "Report_Relatorio_Nao_Cumprimento_Meta");
            ...
            using (var db = new SgqDbDevEntities())
            {
                ...
                _todosOsGraficos.listResultSetLevel1 = db.Database.SqlQuery<NaoCumprimentoMetaResultSet>(queryIndicadores).ToList();
                _todosOsGraficos.listResultSetTendencia = db.Database.SqlQuery<NaoCumprimentoMetaResultSet>(queryTendencia).ToList();
                ...
                _todosOsGraficos.listResultSetLevel2 = db.Database.SqlQuery<NaoCumprimentoMetaResultSet>(queryGrafico3).ToList();
                _todosOsGraficos.listResultSetTarefaPorIndicador = db.Database.SqlQuery<NaoCumprimentoMetaResultSet>(queryGraficoTarefasAcumuladas).ToList();
                _todosOsGraficos.listResultSetLevel3 = db.Database.SqlQuery<NaoCumprimentoMetaResultSet>(queryGrafico4).ToList();
            }
    ...
    {
        public List<NaoCumprimentoMetaResultSet> listResultSetLevel1 { get; set; }
        public List<NaoCumprimentoMetaResultSet> listResultSetTendencia { get; set; }
        public List<NaoCumprimentoMetaResultSet> listResultSetLevel2 { get; set; }
        public List<NaoCumprimentoMetaResultSet> listResultSetTarefaPorIndicador { get; set; }
        public List<NaoCumprimentoMetaResultSet> listResultSetLevel3 { get; set; }
    ...
    public class NaoCumprimentoMetaResultSet
    {
