    ...
    public class CartasCepApiController : ApiController
    {
        ...
        public CartasCepResultSet GetApontamentosDiarios([FromBody] FormularioParaRelatorioViewModel form)
        {
            ...
            else
            {
                ...
                "\n                                                                                                                                         " +
                "\n /* Média */                                                                                                                             " +
                "\n select @MEDIA = (SUM(DEFEITOS) / SUM(AV)) * 100, @N = avg(N) from                                                                                                  " +
...
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n           WHEN @TIPOCONSOLIDACAO = 1 THEN(CAST(SUM(WeiEvaluation) AS DECIMAL(20, 10)))                                                                                                                                                                                            " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n           WHEN @TIPOCONSOLIDACAO = 2 THEN(CAST(SUM(WeiEvaluation) AS DECIMAL(20, 10)))                                                                                                                                                                                            " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n           WHEN @TIPOCONSOLIDACAO = 3 THEN(CAST(SUM(EvaluatedResult) AS DECIMAL(20, 10)))                                                                                                                                                                                          " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n           WHEN @TIPOCONSOLIDACAO = 4 THEN(CAST(SUM(EvaluatedResult) AS DECIMAL(20, 10)))                                                                                                                                                                                          " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n           ELSE(CAST(SUM(WeiEvaluation) AS DECIMAL(20, 10)))                                                                                                                                                                                                                       " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n                                                                                                                                                                                                                                                                                   " +
"\n       END                                                                                                                                                                                                                                                                         " +
"\n  END AS AV,                                                                                                                                                                                                                                                               " +
