...
"\n   DECLARE @DATAFINAL   DATETIME = '" + form._dataFimSQL + " 23:59'                                                                                                                                                                                                                    					                                               " +
               ...
               "\n CREATE TABLE #AMOSTRATIPO4 ( " +
                ...
                "\n INDICADOR INT NULL, " +
                "\n AM INT NULL, " +
                "\n DEF_AM INT NULL, DATA DATE NULL " +
                "\n ) " +
                ...
                */
                ...
                "\n , SUM(IIF(C2.WeiDefects = 0, 0, 1)) DEF_AM , CAST(C2.CollectionDate AS DATE) DATA" +
...
"\n 	DIASABATE INT NULL,                                                                                                                                                                                                                                                                                                                " +
"\n 	VOLUMEPCC INT NULL, unitid int null, data datetime null                                                                                                                                                                                                                                                                                                                 " +
"\n   )                                                                                                                                                                                                                                                                                                                                    " +
"\n   INSERT INTO #VOLUMES                                                                                                                                                                                                                                                                    					                           " +
"\n   SELECT COUNT(1) AS DIASABATE, SUM(Quartos) AS VOLUMEPCC, ParCompany_id as UnitId, cast(Data as date) as data  FROM VolumePcc1b WHERE Data BETWEEN @DATAINICIAL AND @DATAFINAL GROUP BY ParCompany_id  , cast(Data as date)                                                                                                 					                                                                   " +
"\n                                                                                                                                                                                                                                                                                                                                        " +
...
"\n                SELECT                                                                                                                                                                                                                                               						                                           " +
"\n                COUNT(1) AS NA,                                                                                                                                                                                                                                                                                                         " +
"\n 			   C2.UnitId, convert(date, C2.CollectionDate) as Data                                                                                                                                                                                                                                      						                                                   " +
...
"\n                AND IsNotEvaluate = 1                                                                                                                                                                                                                                						                                           " +
"\n                GROUP BY C2.ID, C2.UnitId, convert(date, C2.CollectionDate)                                                                                                                                                                                                                                       						                                   " +
"\n            ) NA		                                                                                                                                                                                                                                                        						                                   " +
"\n            WHERE NA = 2                                                                                                                                                                                                                                             						                                           " +
...
"\n  , Criterio                                                                                                                                                                                                                                                                                                                                                   " +
"\n  , CriterioName                                                                                                                                                                                                                                                                                                                                               " +
"\n  , case when Level1Id = 3 then sum(av) else sum(av) end av                                                                                                                                                                                                                                                                                                                                                 " +
"\n  , sum(nc) nc                                                                                                                                                                                                                                                                                                                                                 " +
"\n  , (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) pontos                                                                                                                                                                                                                                                                                                                                         " +
"\n  , (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) pontosIndicador                                                                                                                                                                                                                                                                                                                                " +
"\n  , max(meta) meta                                                                                                                                                                                                                                                                                                                                             " +

"\n  , case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) * 100) end end real " +
"\n  , case when (case when(isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) > 100 then 100 else (isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) end) < 70 then 0 else (case when(isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) > 100 then 100 else (isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) end / 100) end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) as pontosAtingidos  " +
"\n  , case when(isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) > 100 then 100 else (isnull(case when (case when Level1Id = 3 then sum(av) else sum(av) end) = 0 then 0 else case when sum(nc) = 0 then (case when tipoIndicador = 1 then 100 else 0 end) else case when tipoIndicador = 1 then(max(meta) / (sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end))) else ((sum(nc) / (case when Level1Id = 3 then sum(av) else sum(av) end)) / max(meta) * 100 * 100) end end * (CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END) / nullif((CASE WHEN SUM(AV) = 0 THEN 0 ELSE max(pontos) END), 0) end, 0)) end as Scorecard " +

"\n  , TipoScore " +
"\n  , cast(YEAR(mesData) as varchar) + '-' +  cast(month(mesData) as varchar) mesData FROM                                                                                                                                                                                                                                           " +
           "\n (                                                                                                                                                                                                                                                                   " +
           "\n SELECT                                                                                                                                                                                                                                                              " +
           "\n                                                                                                                                                                                                                                                                     " +
           "\n   Cluster                                                                                                                                                                                                                                                           " +
           ...
           "\n /* INICIO SCORECARD COMPLETO-------------------------------------*/                                                                                                                                                                                                 " +
           "\n CASE                                                                                                                                                                                                                                                                " +
           "\n     WHEN Level1Id = 43 THEN case when NC = 0 then 0 when (Meta / NC) > 1 then 1 when (Meta / NC) < 0.70 then 0 else Meta / NC end                                                                                                                                                                                                                                                                 " +
           "\n     WHEN                                                                                                                                                                                                                                                            " +
           "\n     /*INICIO SCORECARD------------------------------------------------*/                                                                                                                                                                                            " +
           "\n     CASE                                                                                                                                                                                                                                                            " +
           "\n                                                                                                                                                                                                                                                                     " +
  ...
  "\n   , ISNULL(CL1.ConsolidationDate, FT.Data) as mesData                                                                                                                                                                                                                       " +
           ...
           "\n     CASE                                                                                                                                                                                                                                                              					                                               " +
            ...
            "\n                                                                                                                                                                                                                                                                       					                                               " +
            "\n      WHEN L1.hashKey = 1 THEN (SELECT sum(VOLUMEPCC) FROM #VOLUMES WHERE UnitId = C.Id and CAST(ISNULL(CL1.ConsolidationDate, FT.Data) AS DATe) = Data) - (SELECT isnull(sum(NAPCC),0) FROM #NAPCC WHERE UnitId = C.Id and CAST(ISNULL(CL1.ConsolidationDate, FT.Data) AS DATE) = Data)                                                                                                                                                                                         " +
            "\n                                                                                                                                                                                                                                                                       					                                               " +
          ...
          "\n     CASE                                                                                                                                                                                                                                                              					                                               " +
           ...
           "\n         ON A4.UNIDADE = C.Id                                                                                                                                                                                                                                      " +
           "\n         AND A4.INDICADOR = L1.ID  AND A4.data = CAST(CL1.ConsolidationDate AS DATE)                                                                                                                               " +
...
"\n  --------------------------                                                                                                                                                                                                                                                    " +
           ...
           "\n                                                                                                                                                                                                                                                                     " +
           "\n ) FIM                                                                                                                                                                                                                                                               " +
           "\n INNER JOIN ParCompany PC on PC.id = FIM.ParCompanyId and PC.IsActive = 1                                                                                                                                                                                                                                                                    " +
"\n    ) SC                                                                                                                                                                                                                                                               					                                               " +
...
"\n   , CriterioName         " +
"\n   , TipoScore            " +
"\n   , cast(YEAR(mesData) as varchar) + '-' +  cast(month(mesData) as varchar)           " +
