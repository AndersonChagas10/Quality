    ...
    public class NaoConformidadeRHApiController : BaseApiController
    {
        ...
        public List<NaoConformidadeRHResultsSet> GraficoHolding([FromBody] DTO.DataCarrierFormularioNew form)
        {
            ...
            var query = $@"
				...
				LEFT JOIN (SELECT 
	                            S1.ID,S1.NAME
	                        FROM ParStructureGroup S1	
	                        INNER JOIN ParStructureGroup S2
		                        ON S1.ID = S2.ParStructureGroupParent_Id
	                        INNER JOIN ParStructureGroup S3
		                        ON S2.ID = S3.ParStructureGroupParent_Id) Holding on CuboL3.Holding = Holding.Id
                WHERE 1 = 1
                ...
                SELECT 
					...
					LEFT JOIN (SELECT 
	                            ...
	                            INNER JOIN ParStructureGroup S2
		                            ON S1.ID = S2.ParStructureGroupParent_Id
	                            INNER JOIN ParStructureGroup S3
		                            ON S2.ID = S3.ParStructureGroupParent_Id) GrupoDeEmpresa on CuboL3.GrupoDeEmpresa = GrupoDeEmpresa.Id
	                WHERE 1=1
	                AND CollectionDate BETWEEN @DATAINICIAL AND @DATAFINAL
                ...
                SELECT 
					...
					LEFT JOIN (SELECT 
	                            ...
	                            INNER JOIN ParStructureGroup S2
		                            ON S1.ID = S2.ParStructureGroupParent_Id
	                            INNER JOIN ParStructureGroup S3
		                            ON S2.ID = S3.ParStructureGroupParent_Id) Regional on CuboL3.Regional = Regional.Id
	                WHERE 1=1
	                AND CollectionDate BETWEEN @DATAINICIAL AND @DATAFINAL
        ...
        [HttpPost]
        [Route("GraficoDepartamentosPai")]
        public List<NaoConformidadeRHResultsSet> GraficoDepartamentosPai([FromBody] DTO.DataCarrierFormularioNew form)
        {
        ...
        [HttpPost]
        [Route("GraficoCargos")]
        public List<NaoConformidadeRHResultsSet> GraficoCargos([FromBody] DTO.DataCarrierFormularioNew form)
        {
...
public class NaoConformidadeRHResultsSet
{
    ...
    public string DepartamentoPaiName { get; set; }
    public string DepartamentoPai_Id { get; set; }
