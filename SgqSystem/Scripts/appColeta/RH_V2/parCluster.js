...
function listarParCluster(isVoltar) {
    ...
    _readFile("parCluster.txt", function (data) {
        ...
        $(data).each(function (i, o) {
            ...
            htmlParCluster += '<div class="col-xs-6 col-md-4" style="padding:2px;padding-left: 30px!important;padding-right: 30px!important"><button type="button" class="list-group-item btn btn-lg btn-block"  style="color: #1F497D;background-color:#DCE6F1;overflow-x:hidden" data-par-cluster-id="' + o.Id + '" title="' + o.Name + '">' + o.Name +
                '</button></div>';
        });
        htmlParCluster += "</div>";
