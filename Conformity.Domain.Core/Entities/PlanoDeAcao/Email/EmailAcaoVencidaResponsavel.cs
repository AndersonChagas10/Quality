...
namespace Conformity.Domain.Core.Entities.PlanoDeAcao
{
    public class EmailAcaoVencidaResponsavel : IEmail
    {
        ...
        public void MontarBody(Acao acao)
        {
            ...
            Olá!
            <br><br>
	        Seguindo o parâmetro da regra de Plano de Ação cadastrada no sistema SG-SESMT, informamos que a Ação descrita a seguir, de sua responsabilidade pela execução, venceu em { acao.DataConclusao?.ToString("dd/MM/yyyy") ?? "" }.
