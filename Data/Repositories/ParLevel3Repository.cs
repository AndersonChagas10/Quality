...
namespace Data.Repositories
{
    public class ParLevel3Repository : IParLevel3Repository
    {
        ...
        {
            var query = string.Format("select * from ParLevel3Level2 p32 INNER JOIN ParLevel3Level2Level1 p321 ON p321.ParLevel3Level2_Id = p32.Id WHERE p321.ParLevel1_Id = {0}", idLevel1);
